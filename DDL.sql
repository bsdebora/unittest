...
(
	...
	CONSTRAINT ComplaintID PRIMARY KEY (COMPLAINT_t),
	CONSTRAINT ComplaintID FOREIGN KEY (EMPLOYEE_t) REFERENCES EMPLOYEE_t(EmployeeID)
);


-- DATA INSERTION
INSERT INTO COMPLAINT_t VALUES (10, 'Dani Doyleh', 101,'French Fries');
